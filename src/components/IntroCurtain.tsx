...
export function IntroCurtain() {
  return (
    <motion.div
      aria-hidden="true"
      className="pointer-events-none fixed inset-0 z-[80] overflow-hidden bg-[#050505]"
      initial={{ opacity: 1 }}
      animate={{ opacity: 0 }}
      transition={{ duration: 1.35, ease: [0.22, 1, 0.36, 1], delay: 0.15 }}
    >
      <motion.div
        className="absolute left-1/2 top-1/2 h-[120vmax] w-[120vmax] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(61,215,255,0.12),rgba(61,215,255,0.035)_18%,transparent_42%)]"
